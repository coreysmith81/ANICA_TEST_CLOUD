Codeunit 50105 "Telxon Quick Input"
{
    ...
    begin
        ...
        JnlSelected := true;
        PageID := 50042;//50042 Telxon Quick Input Page, 50044 Telxon Recurring Page
        RecurringJnl := false;//TRUE for Recurring, FALSE for Quick Input
