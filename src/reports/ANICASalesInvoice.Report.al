Report 50035 "ANICA Sales Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ANICA Sales Invoice.rdlc';
    ...
    dataset
    {
        dataitem("Sales Invoice Header";"Sales Invoice Header")
        {
            ...
            RequestFilterFields = "Document Date","No.","Sell-to Customer No.","Bill-to Customer No.","Ship-to Code","No. Printed","Posting Date";
            ...
            dataitem(CopyLoop;"Integer")
            {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    column(VHideMargin;VHideMargin)
                    {
                    }
                    dataitem("Sales Invoice Line";"Sales Invoice Line")
                    {
                        ...
                        column(PONumber;"Purchase2 Order No.")
                        {
                        }
        ...
        layout
        {
            area(content)
            {
                group(Options)
                {
                    ...
                    field(VHideMargin;VHideMargin)
                    {
                        ApplicationArea = Basic;
                        Caption = 'Hide Retail|Margin|GPM';
                    }
                }
            }
        }
