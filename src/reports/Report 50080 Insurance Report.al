Report 50080 "Insurance Report"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Insurance Report.rdlc';
    ...
    dataset
    {
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            column(ANICA_INSURANCE_REPORTCaption; ANICA_INSURANCE_REPORTCaptionLbl)
            {
            }
            ...
            column(SHIPPING_CODECaption; SHIPPING_CODECaptionLbl)
            {
            }
            ...
            dataitem("Sales Invoice Line"; "Sales Invoice Line")
            {
                ...
                column(Sales_Invoice_Header___Shipping_Instruction_Code_; "Sales Invoice Header"."Shipping Instruction Code")
                {
                }
                ...
                begin
                    ...
                    InsurncAmt := "Sales Invoice Line".Amount;
            ...
            begin
                ...
                if ShipInstruction.Find('-') then begin
                    ShipDesc := ShipInstruction.Description;
                    if ShipInstruction.Legs = true then begin
                    ...
                    if ShipLegs.Find('-') then begin
                        if ShipLegs."Sea or Anch" = 0 then
                            Origin := 'SEATTLE'
                        else
                            Origin := 'ANCHORAGE';
                    end;
    ...
    var
        ...
        PrtAmt: Decimal;
        TotalAmt: Decimal;
        ANICA_INSURANCE_REPORTCaptionLbl: label 'ANICA INSURANCE REPORT';
        ...
        SHIPPING_CODECaptionLbl: label 'SHIPPING CODE';
