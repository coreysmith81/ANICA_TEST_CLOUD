Report 50070 "Cross Reference Open PO's SO"
{
    ...
    dataset
    {
        dataitem("Purchase Header";"Purchase Header")
        {
            ...
            RequestFilterFields = "Document Date","Location Code",Field99001925,Approved,"No.","Buy-from Vendor No.","Shipping Instruction Code","Your Reference",Field99001901;
            ...
            begin
                ...
                if "Purchase Header".Status = 1 then PReleased := 'X';
