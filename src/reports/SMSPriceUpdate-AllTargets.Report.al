Report 50196 "SMS Price Update - All Targets"
{
    ProcessingOnly = true;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting(Target,Priority) order(ascending) where("SMS Update"=const(true));
            ...
            begin
                //Mark all Nonstock Items TRUE on "Price Files Created Field.
                Nonstocks.SetRange("Price Files Created",false);
                Nonstocks.ModifyAll("Price Files Created",true);

                //Mark all Items TRUE on "Price Files Created Field.
                Items.SetRange("Price Files Created",false);
                Items.ModifyAll("Price Files Created",true);
            end;
        }
    }
    ...
    begin
        ...
        //Filename section
        VFileName := 'SMSItems.txt'; //Enter a fixed filename for now
