Report 50043 "Daily Sales Order Summary"
{
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            RequestFilterFields = "Document Date", "Location Code", Approved, "No.", "Shipping Instruction Code";
            ...
            begin
                ...
                if PPurchOrder <> '' then begin
                    ...
                    if PurchHead.Find('+') then begin
                        ...
                        if PurchHead.Status = "Purchase Document Status"::Released then POReleased := 'X';
                    end;
                end;
