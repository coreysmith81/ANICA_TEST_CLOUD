Report 50137 "Rebate Customer List by Name"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Rebate Customer List by Name.rdlc';

    dataset
    {
        dataitem("Rebates Customers";"Rebates Customers")
        {
            DataItemTableView = sorting("Rebate Store No.","Customer Name") order(ascending);
