Report 50110 "JBG Reused Items -- LIST ONLY"
{
    // //This program checks for Reused Items after JBG Catalog Price Update.
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/JBG Reused Items -- LIST ONLY.rdlc';
    ...
    dataset
    {
        dataitem("JBG Item Weekly Table"; "JBG Item Weekly Table")
        {
            ...
            begin
                ...
                if (VIsFound = true) and (VCheckUPC <> VNewUPC) and (VGrossWeight <> VCheckGrossWt) then begin
    ...
    begin
        ...
        //VCurrentImportDate := 20190930D;
        //VPrevImportDate := 20190923D;
    ...
    begin
        ...
        if NonStockRecord.Find('+') then begin
            ...
            //Hazmat section
            if VPostIndicator = '3' then begin
            ...
            Error('NonStock Item Not Found %1', VVendorItem);
    ...
    begin
        ...
        if ItemUOM.Find('-') then begin
            ...
            Error('UOM Not Found %1', VCheckItem);
    end;
