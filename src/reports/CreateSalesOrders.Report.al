Report 50024 "Create Sales Orders"
{
        ...
        dataitem("Telxon Input File";"Telxon Input File")
        {
            ...
            begin
                ...
                begin
                    ...
                    if ("Vendor No." = 'JBGO001') and (("Customer Number" = 'KIKI001') or ("Customer Number" = 'ATKA001')
                            or ("Customer Number" = 'DIOM001')) then
                        begin
                    ...
                    if "Vendor No." <> 'JBGO001' then
                        begin
                            ...
                            if ("Pick code" = 1) or ("Pick code" = 2) or ("Pick code" = 5) or ("Pick code" = 18) or ("Pick code" = 7) or
                                    ...
                                    ("Pick code" = 13) or ("Pick code" = 14) or ("Pick code" = 15) or ("Pick code" = 17) then
                    ...
                    if VEndOfFile = T then
                        begin
                            ...
                            case "Shipping Code" of
                                'DEF AIR' : VNewShipInstruct := '027';
                                'DEF SEA' : VNewShipInstruct := '005';
                                'DEF ANC' : VNewShipInstruct := '006';
                                else VNewShipInstruct := "Shipping Code"
                            end;
            ...
            begin
                ...
                if NoSeriesLine.Find('+') then
                    begin
                        if VLineOrderNo > NoSeriesLine."Last No. Used" then
                        begin
    ...
    begin
        ...
        SalesHeaderRecord."Document Type" := 1;
