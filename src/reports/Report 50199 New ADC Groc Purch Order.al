            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    dataitem("Purchase Line"; "Purchase Line")
                    {
                        ...
                        begin
                            ...
                            if OnLineNumber = NumberOfLines then begin
                                ...
                                if "Purchase Header"."Tax Area Code" <> '' then begin
                                    ...
                                    //CS>>>CHECK THE TempSalesTaxAmtLine variables below.  
                                    Reset;
                        ...
                        begin
                            //CurrReport.CreateTotals(AmountExclInvDisc,"Line Amount","Inv. Discount Amount"); //CreateTotals deprecated. Handle in Report Designer.
                            NumberOfLines := Count;
                            OnLineNumber := 0;
                            PrintFooter := false;
                        end;
