Report 50131 "G/L 104-02 Checks"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/GL 104-02 Checks.rdlc';
    ...
    dataset
    {
        dataitem("G/L Entry";"G/L Entry")
        {
            ...
            column(G_L_104_02_ChecksCaption;G_L_104_02_ChecksCaptionLbl)
            {
            }
            ...
            begin
                ...
                "G/L Entry".SetFilter(Description,'*Check for*');
    ...
    var
        ...
        TotalRec: Integer;
        CurRec: Integer;
        G_L_104_02_ChecksCaptionLbl: label 'G/L 104-02 Checks';
