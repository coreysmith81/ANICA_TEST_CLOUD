    ...
    dataset
    {
        dataitem("Telxon Input File"; "Telxon Input File")
        {
            ...
            begin
                ...
                if "Telxon Input File".Store = CheckStore then begin
        ...
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            dataitem("Sales Line"; "Sales Line")
            {
                ...
                begin
                    ...
                    if "Sales Line".Type <> "Sales Line Type"::Item then CurrReport.Skip;
                    //Check only lines with a quantity
                    if "Sales Line".Quantity = 0 then CurrReport.Skip;

                    VSalesPrintLine := false;

                    if "Sales Line"."Document No." = CheckOrder then begin
            ...
            begin
                //Skip Quotes
                if "Sales Header"."Document Type" = "Sales Document Type"::Quote then CurrReport.Skip;
