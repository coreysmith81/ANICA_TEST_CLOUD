Report 50047 "ANICA Purchase Order - New"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/ANICA Purchase Order - New.rdlc';
    ...
    dataset
    {
        dataitem("Purchase Header";"Purchase Header")
        {
                ...
                dataitem(PageLoop;"Integer")
                {
                    ...
                    dataitem("Purchase Line";"Purchase Line")
                    {
                        ...
                        begin
                            ...
                            TGrossWeight := "Purchase Line".Quantity * "Purchase Line"."Gross Weight";
                        end;
            ...
            trigger OnAfterGetRecord()
            begin
                if "Purchase Header"."Location Code" = 'ADC' then
                begin
                //Get Sell To customer
                if CustomerRecord.Get("Purchase Header"."Sell-to Customer No.") then
                begin
                ...
                if "Purchase Header"."Ship-to Code" = 'ADC' then
                begin
                if "Purchase Header"."Sell-to Customer No." = '' then
                begin
                FormatAddress.Customer(SellToAddress,CustomerRecord);
                ShipToAddress[1] := SellToAddress[1];
                ShipToAddress[2] := SellToAddress[2];
                ShipToAddress[3] := SellToAddress[3];
                ShipToAddress[4] := SellToAddress[4];
                CompressArray(SellToAddress);
                end
                else
                begin
                ShipToAddress[1] := "Purchase Header"."Ship-to Name";
                ShipToAddress[2] := "Purchase Header"."Ship-to Address";
                ShipToAddress[3] := "Purchase Header"."Ship-to Address 2";
                ShipToAddress[4] := "Purchase Header"."Ship-to City" + ' ' + "Purchase Header"."Ship-to County" + ' ' +
