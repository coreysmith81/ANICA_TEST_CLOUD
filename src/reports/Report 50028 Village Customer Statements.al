        ...
        dataitem(Customer; Customer)
        {
            ...
            dataitem("Cust. Ledger Entry"; "Cust. Ledger Entry")
            {
                ...
                begin
                    ...
                    if "Cust. Ledger Entry"."Document Type" = "Gen. Journal Document Type"::Payment then begin
                        Payment := "Cust. Ledger Entry"."Amount (LCY)";
                    end;
                    if "Cust. Ledger Entry"."Document Type" = "Gen. Journal Document Type"::" " then begin
                        if VDoc = 'G' then SJE := "Cust. Ledger Entry"."Amount (LCY)";
                    end;
                    if "Cust. Ledger Entry"."Document Type" = "Gen. Journal Document Type"::Invoice then begin
                        if VDoc = 'E' then
                            SJE := "Cust. Ledger Entry"."Amount (LCY)"
                        else
                            Saleable := "Cust. Ledger Entry"."Amount (LCY)";
                        if "Cust. Ledger Entry"."Store Use" <> 0 then begin
                            NonSale := "Cust. Ledger Entry"."Store Use";
                            Saleable := "Cust. Ledger Entry"."Amount (LCY)" - "Cust. Ledger Entry"."Store Use";
                        end;
                        if "Cust. Ledger Entry"."Snow Machines" <> 0 then begin
