Report 50010 "JBG Catalog Update"
{
    ...
    dataset
    {
        dataitem("JBG Item Weekly Table"; "JBG Item Weekly Table")
        {
            ...
            {
                DataItemLink = "Vendor Item No." = field("Vendor Item No");
                ...
                begin
                    ...
                    begin
                        ...
                        if ItemExists = false then begin
                            Init;
                            Insert(true);
                        end;
                        ...
                        //Hazmat section
                        if NPostIndicator = '3' then begin
                            "Hazardous Code" := true;
                            "FOB Code" := 'HAZ';
                            "Pick Type" := 1;
                        end
                        ...
                        if NPostIndicator = '6' then begin
                            "WIC Flag" := true;
                        ...
                        if CommodityTable.Find('-') then begin
                            if "WIC Flag" = true then begin
            ...
            begin
                if Date2dwy(Today, 1) <> 1 then
                    ...
                    //VImportDate := TODAY;
                    VImportDate := 20150622D;

                "JBG Item Weekly Table".SetCurrentkey("Import Date", "Vendor Item No");
                "JBG Item Weekly Table".SetRange("Import Date", VImportDate);
            end;
        }
    }
    ...
    var
        ...
        NCoGroup: Code[10];
        VPack: Decimal;
        VPackDescription: Text[10];
        NPostIndicator: Code[10];
        VHazardousCode: Code[10];
        NFoodNFood: Code[10];
        NPriceAllow: Decimal;
        NTarget: Decimal;
        NMastRetail: Decimal;
    ...
    begin
        ...
        if NonStocks.Find('+') then begin
            ...
            if NonStocks."Do Not Update JBG Retails" = true then begin
    ...
    begin
        ...
        if ItemRecord.Find('+') then begin
            ...
            if VCheckUpdatePrice = true then begin
            ...
            if ItemRecord."Created From Nonstock Item" = true then begin
    ...
    var
        CrossReferenceRecord: Record "Item Reference";
    begin
    ...
    begin
        ...
        if NonStockUPCTable.Find('+') then begin
