Report 50091 "ANICA Reorder Report"
{
    ...
    dataset
    {
        dataitem(Item;Item)
        {
            ...
            RequestFilterFields = Blocked,"Created From Nonstock Item","Drop Ship Item","ANICA Inactive","Inventory Posting Group","Location Filter","Vendor No.","No.","Search Description","Assembly BOM","Shelf No.","Location Filter","Drop Shipment Filter";
