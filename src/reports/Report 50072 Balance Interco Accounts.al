    ...
    dataset
    {
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
                ...
                case "G/L Account"."No." of
                    '100-00' .. '199-99':
                        ANICAAmount[19] := ANICAAmount[19] + "Balance at Date";
                    '200-00' .. '999-99':
                        ANICAAmount[20] := ANICAAmount[20] + "Balance at Date";
                end;
                ...
                case "G/L Account"."No." of
                    '100-00' .. '199-99':
                        WHSEAmount[19] := WHSEAmount[19] + "Balance at Date";
                    '200-00' .. '999-99':
                        WHSEAmount[20] := WHSEAmount[20] + "Balance at Date";
                end;
                ...
                case "G/L Account"."No." of
                    '100-00' .. '199-99':
                        SKENTAmount[19] := SKENTAmount[19] + "Balance at Date";
                    '200-00' .. '999-99':
                        SKENTAmount[20] := SKENTAmount[20] + "Balance at Date";
                end;
                ...
                case "G/L Account"."No." of
                    '100-00' .. '199-99':
                        ELIMAmount[19] := ELIMAmount[19] + "Balance at Date";
                    '200-00' .. '999-99':
                        ELIMAmount[20] := ELIMAmount[20] + "Balance at Date";
                end;
