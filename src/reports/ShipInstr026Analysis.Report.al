Report 50183 "Ship Instr 026 Analysis"
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Sell-to Customer No.","Order Date") order(ascending) where("Order Date"=filter(01;
    ...
    begin
        ...
        if VCheckCustomer <> "Sales Invoice Header"."Sell-to Customer No." then
        begin
        ...
        case VZone of
        'ZONE N':VParcelRate := 0.373;
        'ZONE 1/2':VParcelRate := 0.455;
        'ZONE 3':VParcelRate := 0.515;
        end;

        case VZone of
        'ZONE N':VPriorityRate := 1.18;
        'ZONE 1/2':VPriorityRate := 0.75;
        'ZONE 3':VPriorityRate := 0.97;
        end;
