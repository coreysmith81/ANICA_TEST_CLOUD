Table 50029 "Telxon Input File"
{
    ...
    fields
    {
        ...
        {
            OptionMembers = " ",Hazardous,Freeze,Dry,Other,"Phone Cards",Pick6,Oils,"Pick Type 2",Snacks,Pop,JBG2740,Chill,Batteries,Ammo,"NR Hazardous",Pick16,Pick17,Tobacco;
        }
        ...
        {
            Description = 'CS 11/5/15: Increasing this to see if it has any unintended consequences.';
        }
        ...
        {
            Description = 'Changed from 10 - CS 10/23/12';
        }
        ...
        field(65;"Order Import Date";Date)
        {
            Description = 'Date order brought into Telxon';
        }
        field(66;"ANICA Commodity Code";Code[10])
        {
        }
        field(67;"Status Note";Text[60])
        {
            Description = 'From Item Card -- "Not Enough Inventory" items.';
        }
        field(68;"Vendor Location";Code[10])
        {
        }
    }
    ...
    keys
    {
        ...
        key(Key12;Date,Store)
        {
        }
        key(Key13;Store,Velocity)
        {
        }
        key(Key14;Store,TotalCost)
        {
        }
        key(Key15;"Processed Date",Store,Processed)
        {
        }
    }
